      ...
      <div className="container mx-auto container-padding flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          <ul className={cn(
            ...
            <li>
              <a href="#why-us" className="hover:text-paris-accent transition-colors">Pourquoi nous</a>
            </li>
            <li>
              <a href="#expertise" className="hover:text-paris-accent transition-colors">Expertise</a>
            </li>
            <li>
              <a href="#projects" className="hover:text-paris-accent transition-colors">Réalisations</a>
            </li>
            <li>
              <a href="#process" className="hover:text-paris-accent transition-colors">Processus</a>
            </li>
          </ul>
          <a 
        ...
        <button 
          className={cn(
            ...
            mobileMenuOpen ? "text-white" : (isScrolled ? "text-paris-navy" : "text-white")
          )}
        ...
        >
          <div className="w-6 flex flex-col gap-1.5">
            <span className={cn(
              ...
              mobileMenuOpen ? "rotate-45 translate-y-2 bg-white" : "bg-current"
            )}></span>
            <span className={cn(
        ...
        <div className={cn(
          ...
          <ul className="flex flex-col gap-5 text-white text-lg">
            <li>
              <a href="#why-us" className="block py-2" onClick={() => setMobileMenuOpen(false)}>
                Pourquoi nous
              </a>
            </li>
            <li>
              <a href="#expertise" className="block py-2" onClick={() => setMobileMenuOpen(false)}>
                Expertise
              </a>
            </li>
            <li>
              <a href="#projects" className="block py-2" onClick={() => setMobileMenuOpen(false)}>
                Réalisations
              </a>
            </li>
            <li>
              <a href="#process" className="block py-2" onClick={() => setMobileMenuOpen(false)}>
                Processus
              </a>
            </li>
            <li className="mt-4">
